  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q4',
        guideline: 'G10',
        guidelineUrl: 'https://www.microsoft.com/en-us/haxtoolkit/library/#guideline-10',
        guidelineTitle: 'Scope services when confidence is low',
        question: 'How will your AI handle uncertainty — what does it do when it is not confident?',
        placeholder:
          'e.g., Show confidence levels, prompt user to confirm before acting, fall back to a simpler task it can handle, escalate to a human, ask clarifying questions...',
        microcopy: 'Excellent! Knowing your limits is a superpower — users trust AI that knows when to ask for help.',
        stageId: 'during',
      },
    ],
  },
